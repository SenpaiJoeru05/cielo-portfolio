      ...
      <div className="container relative z-10 px-6 py-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left reveal">
            ...
            <h1 className="font-display font-bold leading-none text-5xl lg:text-6xl">
              Marie Cielo
              <span className="grad-text block">Balbuena</span>
            </h1>

            <div className="mt-5">
              <p className="text-xl lg:text-2xl text-white font-medium transition-opacity duration-300">
                {roles[currentRole]}
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 mt-10">
              <div className="glass rounded-2xl p-4">
                <h2 className="text-2xl font-bold grad-text">2</h2>
              ...
              <div className="glass rounded-2xl p-4">
                ...
                <p className="text-xs uppercase text-gray-400 mt-1">Graduate</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-center reveal">
            <div
              ref={tiltPhotoRef}
              className="relative w-72 sm:w-80 lg:w-[400px]"
            ...
            >
              ...
              {/* FLOATING CARDS */}
              <div className="glass absolute -left-8 top-8 rounded-xl p-3">
                <p className="font-semibold text-sm">👑 President</p>
                <p className="text-xs text-gray-400">BU Sports Club</p>
              </div>

              <div className="glass absolute -right-6 bottom-14 rounded-xl p-3">
                <p className="font-semibold text-sm">💃 President</p>
                <p className="text-xs text-gray-400">SIKLAB</p>
              </div>

              <div className="glass absolute left-6 bottom-0 rounded-xl p-3">
                <p className="font-semibold text-sm">🥋 University Athlete</p>
                <p className="text-xs text-gray-400">Arnis Team</p>
              </div>
            </div>
          </div>
